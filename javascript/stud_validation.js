...
{ 
  ...
  var error=0;
   ...
   if(document.Registration.join.value){
    document.getElementById("jc").innerHTML="Correct";
     document.getElementById("jc").style.color = "green";
     correct++;
   }else{
    document.getElementById("jc").innerHTML="Please enter join code";
     document.getElementById("jc").style.color = "red";
     document.Registration.join.focus() ;
     error++;
   }
